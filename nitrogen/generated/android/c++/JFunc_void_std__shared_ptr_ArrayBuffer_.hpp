...
namespace margelo::nitro::l2cap {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/l2cap/Func_void_std__shared_ptr_ArrayBuffer_;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/l2cap/Func_void_std__shared_ptr_ArrayBuffer__cxx;";
